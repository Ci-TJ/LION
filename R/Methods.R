...
run_lncPro <- function(seqRNA, seqPro, mode = c("prediction", "retrain", "feature"),
                       ...
                       parallel.cores = 2, cl = NULL, return.model = TRUE, group = NULL, threshold = 0.5, direction = "<", ...) {
        ...
        if (mode == "prediction") {
                ...
                retrained.model <- Internal.randomForest_tune(datasets = list(featureSet), label.col = 1,
                                                              ...
                                                              parallel.cores = parallel.cores, group = group, threshold = threshold, direction = direction, ...)
                message("\n", "+ Completed.  ", Sys.time())
...
run_rpiCOOL <- function(seqRNA, seqPro, mode = c("prediction", "retrain", "feature"),
                        ...
                        seed = 1, parallel.cores = 2, cl = NULL, return.model = TRUE, group = NULL, threshold = 0.5, direction = "<", ...) {
